...
$res=mysql_query($squery);
	...
	if($res)
	{
		echo "<script>alert('record updated with image $code2');</script>".'<br>';
	}
}
else
{
...
<div style="width:810px; height:auto; float:left; margin:auto; border:1px solid #999999; border-radius:5px; margin-top:5px; margin-left:5px; ">
 ...
 <div style=" width:810px; float:left; height:auto;  border:solid 1px #999900; background-color:#006699; border-radius:5px; color:#FFFFFF;" align="right">
<a href="update.php" style="text-decoration:none; color:#FFFFFF;"><input type="button"  value="BACK" style="width:100px; height:25px; color:#FFFFFF; border:#FFFFFF 1px solid; background-color:#000033; border-radius:5px;"></a>
</div>
    
<div style=" width:600px; float:left; height:auto;  border:solid 1px #999900;">

              <table width="600" style="margin-top:0px;" border="10">
   ...
   <!----------------------------------------------------image------------------------------------------------------>
    ...
    <div style="width:150px; height:200px; border:2px solid #999999;border-radius:5px;"><img src='<?php echo"images/$row[image1]";?>' style="height:130px; width:150px;"></div><br />
