...
<title>COMPUTER HARDWARE ASSEMBLY/viewcart</title>
...
<!--slider down data-->
		...
		include('dbconnection.php');
	      ...
	      ?>
            ...
            <td width="300" id="mySelect" align="center"><img src="images/<?php echo $row['image1'];?>" height="70" width="100" style="border:0px solid #000000;" ></td>
...
$amt=$amt+$price;
  ...
  <td  width="100" align="center">Total</td>
    ...
    <td  width="100" align="center"><?php echo"Rs.".$amt;?></td>
            ...
            <div style="width:300px; height:50px; border:0px solid #000000; margin-left:400px;"><a href="index.php"><img src="images/bt_continue_shopping.png"></a>&nbsp;&nbsp;&nbsp;
			
			<button type="submit" onclick="myFunction()" style="border:none;background: none;"><img src="pro.png" /></button></div>
