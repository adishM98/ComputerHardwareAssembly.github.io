...
<?php
		...
		if(!isset($_SESSION['email']) ||(!isset($_SESSION['pwd'])))
			...
			/*	echo "$email";
				...
				echo "$price";*/
				$queryadd="insert into shopping_cart values('','$email','$code','$pro_name','$image','$quantity','$price','$cat')";
...
<!--slider down data-->
        ...
        <?php
          ...
          <!--left image--> <div style="height:300px; width:400px; border:0px solid #990000; margin-top:10px; float:left;" align="center"><a href="admin/images/<?php echo $row['image1'];?>"  class="pirobox" title="<?php echo $row['product_name'];?>"><img src="admin/images/<?php echo $row['image1'];?>" height="150" width="200" style="margin-top:20px; border:0px solid #0000FF;" ></a></div><!--left image close-->
