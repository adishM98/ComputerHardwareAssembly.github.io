...
<!--slider down data-->
         ...
         <font style=" font-size:18px; margin-left:10px;"><b>My Account</b></font>
           ...
           <div style="width:200px; height:248px;background-color:#FFFFFF;border:1px #CCCCCC solid;float:left;"><?php include('left.php'); ?></div>
            ...
            <form name="form1" action="userprof.php" method="post" onSubmit="return validate();">
            ...
            <tr><td colspan="2" align="right"><input type="submit" name="submit2" value="Continue" style="border:1px solid #999999; border-radius:5px; height:35px; width:80px; font-size:16px; margin-right:25px; background-color:#74DBCF;" align="middle"></td></tr>
