...
header('location:login.php'); 
 ...
 $_SESSION['cpu']='false';
$_SESSION['mouse']='false';
 $_SESSION['monitor']='false';
$_SESSION['motherboard']='false';
 $_SESSION['harddisk']='false';
 $_SESSION['powersupply']='false';
 $_SESSION['ram']='false';
 $_SESSION['cabinet']='false';
...
$code=$row['txn_status'];
 ...
 elseif($code=="monitor")
 {
  ...
  elseif($code=="motherboard")
 {
	 $_SESSION['motherboard']='true';
 }
  elseif($code=="harddisk")
 {
	 $_SESSION['harddisk']='true';
 }
 elseif($code=="powersupply")
 {
	 $_SESSION['powersupply']='true';
 }
 elseif($code=="ram")
 {
	 $_SESSION['ram']='true';
 ...
 elseif($code=="cabinet")
 {
	 $_SESSION['cabinet']='true';
	      ...
	      ?>
            ...
            <td width="300" align="center"><img src="admin/images/<?php echo $row['image1'];?>" height="80" width="110" style="border:0px solid #000000;" ></td>
...
$_SESSION['amt']=$amt;
      ...
      <td width="300" style="background-color:#FFFFFF;"></td>
       ...
       <td  width="200" align="center"><?php echo" <font color='#FF0000'> <b>Rs. </b></font>" .$amt;?></td>
            ...
            <a href="checkout.php"><img src="images/bt_prced.png"></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
