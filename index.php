...
<!--slider down data-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='monitor' limit 0,4";
...
?>
 ...
 <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%%%          KEYBOARD              %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='keyboard' limit 0,4";
...
<!--%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%% % MOUSE  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='mouse' limit 0,4";
