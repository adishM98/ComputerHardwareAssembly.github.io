...
<!--slider down data-->
           ...
           <tr><td>
            ...
            <!--%%%%%%%%%%%%%%%%%%%%%%%%%% % MOBILES  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%-->        
			 ...
			 $query="select * from product where pro_cat='cabinet'";
		...
		?>
                  ...
                  <td  style=" width:255px; border:0px solid #0000CC;"align="center" >
                    ...
                    <div style="height:170px; width:230px; float:left;border:0px solid #000000;border-radius:15px;" align="center"><img src="admin/images/<?php echo $row['image1'];?>"                     height="170" width="180"></div> 
